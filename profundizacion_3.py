...
print('El nombre ingresado en minusculas es: ', str.lower(name))
print('El nombre ingresado en mayusculas es: ', str.upper(name))
print('El nombre ingresado en minusculas es: ', str.capitalize(nombre), str.capitalize(apellido))
