...
print('Los dos números solicitados son: ', numero_1, ' y ', numero_2)
...
print('El resultado de dividir ', numero_1, '/', numero_2, 'es: ', division)
# Multiplicación
producto = numero_1 * numero_2
print('El resultado de multiplicar ', numero_1, '*', numero_2, 'es: ', producto)
