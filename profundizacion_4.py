...
print('Ingrese el nombre completo del padre: Nombre y apellido:')
nombre1=str(input())
n1,a1=nombre1.split(' ')
print('Ingrese el nombre completo de la madre: Nombre y apellido:')
nombre2=str(input())
n2,a2=nombre2.split(' ')
...
print('El nombre y apellidos del hijo/a es:', str.capitalize(n3), str.capitalize(a1), str.capitalize(a2))
